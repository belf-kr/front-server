...
const PasswordBox = styled.div<{ isVisible: boolean }>`
  transition: 0.5s;
  ${(props) =>
    props.isVisible
      ? css`
...
export { ButtonBox, DefaultInput, IconBox, PasswordBox, SignBox, SingUpLabel, SubTitle, SubTitleBox, TitleBox, TitleText };
